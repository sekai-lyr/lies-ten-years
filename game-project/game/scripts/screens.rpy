...
screen say(who, what):
    ...
    window:
        ...
        if who is not None:
            ...
            text who id "who":
                xpos gui.name_plain_xpos
                ypos gui.name_ypos

        text what id "what":
            xpos gui.dialogue_plain_xpos
            xsize gui.dialogue_plain_width

    add "gui/reference_menu_dots.png" xpos 1816 ypos 28
...
style window:
    ...
    background Image("gui/textbox_video_haze.png", xalign=0.5, yalign=1.0)
...
style say_label:
    ...
    color "#f4f7fb"
    outlines [ (2, "#1c2b37dd", 0, 0), (1, "#00000099", 0, 1) ]
    xalign 0.0
    yalign 0.0
...
style choice_button is default:
    ...
    xalign 0.5
    padding (42, 0, 42, 0)
    background Frame("gui/choice/choice_idle.png", 36, 18)
    hover_background Frame("gui/choice/choice_hover.png", 36, 18)
    insensitive_background Frame("gui/choice/choice_insensitive.png", 36, 18)
...
style choice_button_text is default:
    ...
    color "#f8eef5"
    hover_color "#ffffff"
    insensitive_color "#c9c1c4"
    outlines [ (2, "#2c1620cc", 0, 0), (1, "#00000088", 0, 1) ]
...
style quick_button:
    ...
    background Solid("#12324166")
    hover_background Solid("#ffffff26")
    selected_background Solid("#2f7f9b66")
    insensitive_background Solid("#10182055")
    xminimum 62
    ysize 34
    padding (12, 2, 12, 2)
...
style quick_button_text:
    ...
    insensitive_color "#8a969e"
    outlines [ (1, "#07131abb", 0, 0) ]
...
screen main_menu():
    ...
    add gui.main_menu_background at live_bg_pan
...
screen game_menu(title, scroll=None, yinitial=0.0, spacing=0):
    ...
    if main_menu:
        ...
        add gui.game_menu_background at live_bg_pan
...
style window:
    variant "small"
    background "gui/textbox_video_haze.png"
